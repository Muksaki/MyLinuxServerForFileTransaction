...
from progressbar import ProgressBar, Percentage, Bar, ETA  #显示进度条
from formatters import FORMATTERS
from urllib.request import urlopen
from urllib.request import Request
from urllib.error import URLError   #爬虫
from urllib.parse import urlencode
timer = time.perf_counter

API_KEY = 'GiLpDAcK9iFGsTkUM5aAPWeC'
SECRET_KEY = 'opP2Lx61COO83192os2sgysXNNVYDNsi'

temppath = "/usr/local/myTomcat/apache-tomcat-8.5.65/webapps/MyLinuxServerForFileTransaction/upload/temp"
...
class WAVConverter(object):
    ...
    def __call__(self, region):
        try:
            ...
            tempname = temppath+'/temp' + str(num) + '.wav'
