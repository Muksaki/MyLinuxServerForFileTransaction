...
<div class="jumbotron jumbotron-fluid text-center col-xl-12">
       <h1 class="display-4">待处理视频上传&nbsp;</h1>
    
       <p class="lead">Upload Your Video To Process</p>
</div>
  <div class="container">
...
<p>Using Our System to get the best recognition of your teaching classes!&nbsp; </p>
      ...
      <form class="my-2 my-lg-0" method="post" action="servlet/FileTransaction" enctype="multipart/form-data">
        <p>&nbsp;</p>
        <p>&nbsp;</p>
            <input class="form-control mr-sm-2" type="file" name="uploadFile"><br/>
